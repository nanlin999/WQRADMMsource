...
// Compute the weights
// [[Rcpp::export]]
Rcpp::List WSCPP(arma::mat x, arma::vec y, arma::vec rep, double tau, arma::vec betahat, bool intercept, String corrtype = "ar1", double epsw = 1e-06, double maxstepw = 100){
...
// [[Rcpp::export]]
Rcpp::List WQRADMMCPP(arma::mat x, arma::vec y, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "ar1", double rhoCQR = 1, double rhoWQR = 1, double eps = 1e-04, double epsw = 1e-06, int maxstep = 3000, int maxstepw = 100){
...
// [[Rcpp::export]]
Rcpp::List paraWQRADMMCPP(arma::mat x, arma::vec y, int K, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "ar1", double rhoCQR = 1, double rhoWQR = 1, double eps = 1e-04, double epsw = 1e-06, int maxstep = 3000, int maxstepw = 100){
